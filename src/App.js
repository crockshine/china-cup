...
export default function App() {
    return (
      <div className="Window flex flex-col h-screen w-screen overflow-hidden" style={{ fontFamily: 'Roboto,sans-serif' }}>
        <Header />
...
<div className="LeftBar h-full px-4 sm:px-10 pb-10 w-80 border flex flex-col items-center justify-between overflow-auto">
  ...
  <div className="flex flex-col w-full gap-2">
    ...
    <div className="bg-slate-600 w-full h-6 sm:h-10"></div>
          ...
          <div className="RightBar flex-grow bg-gray-100 border h-full overflow-y-auto">
            <Profile />
          </div>
        </div>
      </div>
